...
import com.fractal.etcd.config.util.BeanTypeConvertUtil;
import com.fractal.etcd.config.annotation.EtcdValue;
import com.fractal.etcd.config.component.EtcdConfigServiceImpl;
import com.fractal.etcd.config.event.UpdateReferenceListener;
